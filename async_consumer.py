...
class Consumer(object):
    ...
    def __init__(self, amqp_url, exchange_name, queue_name, routing_key):
        ...
        self._consumer = ConsumerBase(self._amqp_url, exchange_name, queue_name,
                                      routing_key)

    def run(self) -> Awaitable:

        try:
            return asyncio.to_thread(self._consumer.run)
    ...
    def _maybe_reconnect(self):
        if self._consumer.should_reconnect:
            ...
            self._consumer = ConsumerBase(self._amqp_url)
